      ...
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-12 md:py-12 border-t border-b border-[rgba(55,50,47,0.12)] dark:border-[rgba(255,255,255,0.08)] flex justify-center items-center gap-6 relative z-10">
        ...
        <div className="w-full max-w-[586px] px-6 py-5 md:py-8 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-6 relative z-20">
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] dark:text-[#E8E6E3] text-3xl md:text-5xl font-sentient leading-tight md:leading-[56px] font-sans tracking-tight">
              Ready to warm your{" "}
              <span className="italic text-primary instrument">Servers?</span>
            </div>
