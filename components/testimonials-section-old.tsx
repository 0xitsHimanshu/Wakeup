...
export function TestimonialsSection() {
  ...
  return (
    <div className="w-full border-b border-[rgba(55,50,47,0.12)] dark:border-[rgba(255,255,255,0.08)] flex flex-col justify-center items-center">
      ...
      {/* Testimonial Content */}
      <div className="self-stretch px-2 overflow-hidden flex justify-start items-center bg-[#F7F5F3] dark:bg-[#0F0E0D] border border-b border-l-0 border-r-0 border-t-0 dark:border-[rgba(255,255,255,0.08)]">
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            <img
              className="w-48 h-50 md:w-48 md:h-50 rounded-lg object-cover transition-all duration-700 ease-in-out dark:invert"
              style={{
            ...
            />
            <div className="flex-1 px-6 py-6 bg-white dark:bg-transparent shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] dark:shadow-[0px_0px_0px_0.75px_rgba(255,255,255,0.12)] overflow-hidden flex flex-col justify-start items-start gap-6 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-[#49423D] dark:text-[#E8E6E3] text-2xl md:text-[32px] font-medium leading-10 md:leading-[42px] font-sans h-[200px] md:h-[210px] overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight"
                style={{
              ...
              >
                <div className="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.90)] dark:text-[rgba(232,230,227,0.90)] text-lg font-medium leading-[26px] font-sans">
                  {testimonials[activeTestimonial].name}
                </div>
                <div className="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.70)] dark:text-[rgba(232,230,227,0.70)] text-lg font-medium leading-[26px] font-sans">
          ...
          <div className="pr-6 justify-start items-start gap-[14px] flex">
            <button
              ...
              className="w-9 h-9 shadow-[0px_1px_2px_rgba(0,0,0,0.08)] dark:shadow-[0px_1px_2px_rgba(255,255,255,0.08)] overflow-hidden rounded-full border border-[rgba(0,0,0,0.15)] dark:border-[rgba(255,255,255,0.15)] justify-center items-center gap-2 flex hover:bg-gray-50 dark:hover:bg-[#1C1A18] transition-colors"
            >
